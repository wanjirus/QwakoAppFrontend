					...
					<Table>
						<TableHead>
							<TableRow>
								...
								<TableCell>Seedlings Planted</TableCell>
								<TableCell>Trees Targeted</TableCell>
								<TableCell>Trees Planted</TableCell>
								<TableCell>Trees Alive</TableCell>
								{/* <TableCell>Monitored Trees</TableCell> */}
						...
						<TableBody>
							<TableRow key={tabledata.user_id}>
								...
								<TableCell>{tabledata.totalseedlings}</TableCell>
								<TableCell>
...
export default IndividualSchoolReport;
