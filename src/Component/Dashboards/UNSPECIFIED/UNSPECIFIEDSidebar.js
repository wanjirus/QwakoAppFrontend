...
const items = [
  ...
  {
    href: "/Generic/Targets",
    icon: EventAvailableIcon,
    title: "Trees Targeted",
  },
  {
    href: "/Generic/Planting",
    icon: PublicIcon,
    title: "Trees Planted",
  },
  {
    href: "/Generic/Monitoring",
    icon: InsightsIcon,
...
const UnspecifiedDashboardSidebar = ({ onMobileClose, openMobile }) => {
...
UnspecifiedDashboardSidebar.propTypes = {
  onMobileClose: PropTypes.func,
  openMobile: PropTypes.bool,
};

UnspecifiedDashboardSidebar.defaultProps = {
  onMobileClose: () => {},
  openMobile: false,
};

export default UnspecifiedDashboardSidebar;
